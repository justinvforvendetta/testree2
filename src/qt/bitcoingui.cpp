    ...
    rpcConsole(0)
{
    ...
    qApp->setStyleSheet("QMainWindow { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top:15px;padding-bottom:10px;margin:0px; } #spacer { background:rgb(47,87,140);border:none; } #toolbar3 { border:none;width:1px; background-color: rgb(61,133,198); } #toolbar2 { border:none;width:28px; background-color:rgb(61,133,198); } #toolbar { border:none;height:100%;padding-top:20px; background: rgb(47,87,140); text-align: left; color: white;min-width:150px;max-width:150px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1,stop: 0 rgb(47,87,140), stop: 1 rgb(216,252,251),stop: 2 rgb(59,62,65));} QToolBar QToolButton { font-family:Century Gothic;padding-left:20px;padding-right:150px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: rgb(47,87,140) } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: rgb(47,87,140); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(47,87,140), stop: 1 rgb(149,204,244)); } QMenuBar { background: rgb(47,87,140); color:white; } QMenuBar::item { font-size:12px;padding-bottom:8px;padding-top:8px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(47,87,140), stop: 1 rgb(149,204,244)); }");
#ifndef Q_OS_MAC
    ...
    connect(graphpage, SIGNAL(transactionClicked(QModelIndex)), this, SLOT(gotoGraphpage()));
    connect(graphpage, SIGNAL(transactionClicked(QModelIndex)), transactionView, SLOT(focusTransaction(QModelIndex)));
...
void BitcoinGUI::createActions()
{
    ...
    graphpageaction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
...
void BitcoinGUI::gotoGraphpage()
{
    graphpageaction->setChecked(true);
    centralWidget->setCurrentWidget(graphpage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DogeCoinDark address or malformed URI parameters."));
    }
...
void BitcoinGUI::miningOn(int processes)
{
    labelMiningIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
     labelMiningIcon->setToolTip(tr("Mining.."));
