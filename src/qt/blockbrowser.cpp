...
{    
    ...
    {
        ui->heightLabel->show();
        ui->heightLabel->setTextInteractionFlags(Qt::TextSelectableByMouse);
        ui->heightLabel_2->show();
        ui->heightLabel_2->setTextInteractionFlags(Qt::TextSelectableByMouse);
        ui->hashLabel->show();
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " GCC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " GCC");
    }
}
