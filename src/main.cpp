...
static CBigNum bnProofOfStakeLimit(~uint256(0) >> 12);

static CBigNum bnProofOfWorkLimitTestNet(~uint256(0) >> 16);
static CBigNum bnProofOfStakeLimitTestNet(~uint256(0) >> 30);

unsigned int nStakeMinAge = 60 * 60 * 12 * 1;	// minimum age for coin age:  7h
...
int64 nChainStartTime = 1431720183;//1404467145;
...
const string strMessageMagic = "Reecoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_PSEUD_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Reecoin
    bool fStrictPayToScriptHash = true; // Always active in Reecoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Reecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Reecoin is Here!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xd7567ce1cc0508b8d95240cef1bb554dada136c4ab745b91868fece537309931"));
