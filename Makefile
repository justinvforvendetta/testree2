#############################################################################
# Makefile for building: Reecoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ????? 23. ???? 16:48:19 2015
# Project:  Reecoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe USE_IPV6=- USE_UPNP=- USE_QRCODE=1 -o Makefile Reecoin-qt.pro
#############################################################################
...
Makefile: Reecoin-qt.pro  ../../QT/4.8.5/mkspecs/default/qmake.conf ../../QT/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_IPV6=- USE_UPNP=- USE_QRCODE=1 -o Makefile Reecoin-qt.pro
